...
const myClass = [
  { name: "marshall", age: 21, date: "2022 - 11 - 22" },
  { name: "chaeddong", age: 23, date: "2023 - 11 - 24" },
  { name: "sejin", age: 20, date: "2017 - 04 - 23 " },
];
console.log(myClass);

// 3. JSON 데이터는 반복 문법을 사용하여 접근할 수 있다.
const classMemberes = myClass.map((member) => {
...
async function fetchIPHONE(num) {
